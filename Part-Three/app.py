...
# Test your current Python environment
import sys
print(sys.path)
...
def create_mongodatabase():
    try:
        ...
        if 'cloud_native' not in dbnames:
            ...
            db_tweets.insert({
            "body": "New blog post, launch your app with the MongoDB databse - cloud_native! ",
            "id": 18,
            "timestamp": "2019-09-23T06:39:40Z",
            "tweetedby": "popkee"
            })

            db_api.insert( {
              "buildtime": "2019-09-23 10:00:00",
              "links": "/api/v1/users",
