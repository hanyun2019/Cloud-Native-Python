...
class FlaskappTests(unittest.TestCase):
    ...
    def test_users_status_code(self):
        ...
        print ("test_users_status_code", result)
    ...
    def test_tweets_status_code(self):
        ...
        print ("test_tweets_status_code", result)
        # assert the status code of the response
        self.assertEqual(result.status_code, 200)
    ...
    def test_addusers_status_code(self):
        ...
        # on the specified path
        result = self.app.post('/api/v1/users', data='{ "username":"michael2", "email": "michaeljackson2@gmail.com", "password": "michael2@123", "name":"Michael2 Jackson"}', content_type='application/json')
        ...
        print ("test_addusers_status_code", result)
        # assert the status code of the response
